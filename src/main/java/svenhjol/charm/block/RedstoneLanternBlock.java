...
public class RedstoneLanternBlock extends BaseLanternBlock {
    ...
    public RedstoneLanternBlock(MesonModule module) {
        super(module, "redstone_lantern", AbstractBlock.Properties.from(Blocks.LANTERN).setLightLevel(p -> p.get(BlockStateProperties.LIT) ? 15 : 0));
        ...
        if (!worldIn.isRemote) {
            ...
            if (flag != worldIn.isBlockPowered(pos)) {
                if (flag) {
                    ...
                    worldIn.setBlockState(pos, WorldHelper.stateWith(state, LIT), 2);
                }
            }
        }
    }

            ...
            transformer: function(method) {
                ...
                for (var i = 0; i < arrayLength; ++i) {
                    ...
                    if (instruction.getOpcode() == Opcodes.ASTORE
                        ...
                        newInstructions.add(ASM.buildMethodCall(ASM_HOOKS, "isSignalFireInRange", "(Lnet/minecraft/util/math/BlockPos;)Z", ASM.MethodType.STATIC));
                ...
                print("[Charm ASM] (WanderingTraderImprovements) " + (success ? "Patched WanderingTraderSpawner" : "Failed to patch WanderingTraderSpawner"));
                return method;
            }
        }
    }

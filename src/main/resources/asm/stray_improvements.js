function initializeCoreMod() {
    ...
    return {
        'stray_improvements': {
            target: {
                'type': 'METHOD',
                'class': 'net.minecraft.entity.monster.StrayEntity',
                'methodName': 'func_223327_b', // canMonsterSpawn ?
            ...
            transformer: function(method) {
                ...
                for (var i = 0; i < arrayLength; ++i) {
                    ...
                    if (instruction.getOpcode() == Opcodes.INVOKEINTERFACE) {
                        ...
                        newInstructions.add(ASM.buildMethodCall(ASM_HOOKS, "canStraySpawnInLight", "(Lnet/minecraft/world/IWorld;Lnet/minecraft/util/math/BlockPos;)Z", ASM.MethodType.STATIC))
                ...
                print("[Charm ASM] (StrayImprovements) " + (success ? "Patched StrayEntity" : "Failed to patch StrayEntity"));
                return method;
            }
        }
    }
